...
function loadImage() {
    document.getElementById("playerPokemonImage").src = "images/pokemon/" + playerPokemon[0].name + ".png";
    document.getElementById("enemyPokemonImage").src = "images/pokemon/" + enemyPokemon[0].name + ".png";
