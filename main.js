...
document.addEventListener('visibilitychange', e=> {
    if (document.visibilityState != 'visible' && document.getElementById("battleStage").style.backgroundImage != 'url("images/lose.gif")' && document.getElementById("battleStage").style.backgroundImage != 'url("images/win.gif")') {
        typing = false;
        switching = false;
    }
});
